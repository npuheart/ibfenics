...
def plot_multiple_lines_1(time, data, labels=None, types=None, colors=None, linestyles=None, 
                        title="", xlabel=None, ylabel=None, xlim=None, ylim=None,xticks=None,yticks=None,ncol=1,legends=None):
    """
    ...
    """
    basic_colors = ["#FC8002","#369F2D","#B9181A","#1663A9","#614099","#369F2D","#B9181A","#1663A9"]
    # basic_linestyles = [":",":",":","-","-","-","--","--","--"]
    basic_linestyles = [":","-.","--","-","-","-","--","--","--"]
    if not labels:
    ...
    if not linestyles:
        linestyles = [basic_linestyles[i%len(basic_linestyles)] for i in range(len(data))]
