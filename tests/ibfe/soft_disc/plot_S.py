...
log_path_s = [
    "soft_disc_be_sav/0.0125/20241212-204012",
    "soft_disc_be_sav/0.0125/20241212-205930",
    "soft_disc_be_sav/0.025/20241212-203240",
    "soft_disc_be_sav/0.025/20241212-202739",
]
...
plot_multiple_lines_1(
    ...
    # ylog=True,
    legends=[
        "SAV-IB-BE, $\Delta t=0.0125,\\alpha=0$",
        "SAV-IB-BE, $\Delta t=0.0125,\\alpha>0$",
        "SAV-IB-BE, $\Delta t=0.025,\\alpha=0$",
        "SAV-IB-BE, $\Delta t=0.025,\\alpha>0$",
        ],
    # markers=["o", "x", "s"],
    # labels=["bdf2-sav", "be"],
